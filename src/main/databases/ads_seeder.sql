...
INSERT INTO users (username, email, password) VALUES ('FrankyIsRad', 'radicaldog@dog.com', 'catssmell'), ('Impact_Blue', 'somelady@west.com', 'catssmell'),('ToddIsGod', 'ted@ToddInBogg.com', 'catssmell');
